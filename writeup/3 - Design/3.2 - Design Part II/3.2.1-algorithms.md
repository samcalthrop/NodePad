...
| Identifier                | Type                     | Component  | Purpose/ Justification |
| ------------------------- | ------------------------ | ---------- | ---------------------- |
| `appBrowserWindowCreated` | `boolean`                | _variable_ |                        |
| `window`                  | `Electron.BrowserWindow` | _variable_ |                        |
| `path`                    | `string`                 | _variable_ |                        |
| `data`                    | `Array<TreeNodeData>`    | _variable_ |                        |
| `fileContents`            | `string`                 | _variable_ |                        |
| `numberOfBrowserWindows`  | `number`                 | _variable_ |                        |
| `process.platform`        | `string`                 | _variable_ |                        |
...
FUNCTION Leaf(node, expanded, hasChildren, elementProps, tree):
  RETURN (
...
| ---------------------- | ----------------------------- | ----------- | ---------------------- |
| `node`                 | ``                            | _parameter_ |                        |
| `expanded`             | ``                            | _parameter_ |                        |
| `hasChildren`          | ``                            | _parameter_ |                        |
| `elementProps`         | ``                            | _parameter_ |                        |
| `node.name`            | ``                            | _variable_  |                        |
| `node.value`           | ``                            | _variable_  |                        |
| `node.hasChildren`     | ``                            | _variable_  |                        |
| `editFileContentsPage` | `string`                      | _variable_  |                        |
| n/a                    | `ReactElement<FileIconProps>` | _return_    |                        |
...
| ------------------ | --------------------- | ----------- | ---------------------- |
| `name`             | ``                    | _parameter_ |                        |
| `isFolder`         | ``                    | _parameter_ |                        |
| `expanded`         | ``                    | _parameter_ |                        |
| `packageJsonIcon`  | ``                    | _variable_  |                        |
| `markdownIcon`     | ``                    | _variable_  |                        |
| `openFolderIcon`   | ``                    | _variable_  |                        |
| `closedFolderIcon` | ``                    | _variable_  |                        |
| n/a                | `string`/ `undefined` | _variable_  |                        |
...
| `y`            | ``        | _parameter_ |                        |
| `nodes`        | ``        | _parameter_ |                        |
| `minDistance`  | ``        | _variable_  |                        |
| `radiusOfNode` | ``        | _variable_  |                        |
| `node`         | ``        | _variable_  |                        |
| `node.x`       | ``        | _variable_  |                        |
| `node.y`       | ``        | _variable_  |                        |
| `distance`     | ``        | _variable_  |                        |
| n/a            | `boolean` | _return_    |                        |
...
| Identifier      | Type                       | Component   | Purpose/ Justification |
| --------------- | -------------------------- | ----------- | ---------------------- |
| `existingNodes` | ``                         | _parameter_ |                        |
| `attempts`      | ``                         | _parameter_ |                        |
| `canvasExists`  | ``                         | _variable_  |                        |
| `i`             | ``                         | _variable_  |                        |
| `x`             | ``                         | _variable_  |                        |
| `y`             | ``                         | _variable_  |                        |
| `canvasHeight`  | ``                         | _variable_  |                        |
| `canvasWidth`   | ``                         | _variable_  |                        |
| n/a             | `draggingConnection.toPos` | _return_    |                        |
...
| `minY`          | ``   | _variable_ |                        |
| `maxY`          | ``   | _variable_ |                        |
| `leftmostNode`  | ``   | _variable_ |                        |
| `rightmostNode` | ``   | _variable_ |                        |
| `lowermostNode` | ``   | _variable_ |                        |
| `uppermostNode` | ``   | _variable_ |                        |
| `padding`       | ``   | _variable_ |                        |
...
| Identifier          | Type | Component  | Purpose/ Justification |
| ------------------- | ---- | ---------- | ---------------------- |
| `context.colour`    | ``   | _variable_ |                        |
| `CONNECTION_COLOUR` | ``   | _variable_ |                        |
| `context.lineWidth` | ``   | _variable_ |                        |
| `connection`        | ``   | _variable_ |                        |
| `connections`       | ``   | _variable_ |                        |
| `node`              | ``   | _variable_ |                        |
| `nodes`             | ``   | _variable_ |                        |
| `node.id`           | ``   | _variable_ |                        |
| `connection.from`   | ``   | _variable_ |                        |
| `fromNode`          | ``   | _variable_ |                        |
| `connection.to`     | ``   | _variable_ |                        |
| `toNode`            | ``   | _variable_ |                        |
| `fromNode.x`        | ``   | _variable_ |                        |
| `fromNode.y`        | ``   | _variable_ |                        |
| `toNode.x`          | ``   | _variable_ |                        |
| `toNode.y`          | ``   | _variable_ |                        |
...
| Identifier                   | Type | Component  | Purpose/ Justification |
| ---------------------------- | ---- | ---------- | ---------------------- |
| `draggingConnection`         | ``   | _variable_ |                        |
| `node.id`                    | ``   | _variable_ |                        |
| `connection.from`            | ``   | _variable_ |                        |
| `fromNode`                   | ``   | _variable_ |                        |
| `fromNode.x`                 | ``   | _variable_ |                        |
| `fromNode.y`                 | ``   | _variable_ |                        |
| `draggingConnection.toPos.x` | ``   | _variable_ |                        |
| `draggingConnection.toPos.x` | ``   | _variable_ |                        |
...
| Identifier          | Type | Component  | Purpose/ Justification |
| ------------------- | ---- | ---------- | ---------------------- |
| `context.fillStyle` | ``   | _variable_ |                        |
| `NODE_COLOUR`       | ``   | _variable_ |                        |
| `node`              | ``   | _variable_ |                        |
| `nodes`             | ``   | _variable_ |                        |
| `node.x`            | ``   | _variable_ |                        |
| `node.y`            | ``   | _variable_ |                        |
...
| ------------------- | ---- | ---------- | ---------------------- |
| `context.fillStyle` | ``   | _variable_ |                        |
| `TEXT_COLOUR`       | ``   | _variable_ |                        |
| `context.font`      | ``   | _variable_ |                        |
| `node`              | ``   | _variable_ |                        |
| `nodes`             | ``   | _variable_ |                        |
| `node.title`        | ``   | _variable_ |                        |
| `node.x`            | ``   | _variable_ |                        |
| `node.y`            | ``   | _variable_ |                        |
...
| `x`                 | ``           | _variable_  |                                                                                |
| `y`                 | ``           | _variable_  |                                                                                |
| `e.clientX`         | ``           | _variable_  |                                                                                |
| `e.clientY`         | ``           | _variable_  |                                                                                |
| `rect.left`         | ``           | _variable_  |                                                                                |
| `rect.top`          | ``           | _variable_  |                                                                                |
| `connection`        | ``           | _variable_  |                                                                                |
| `connections`       | ``           | _variable_  |                                                                                |
| `clickedConnection` | ``           | _variable_  |                                                                                |
...
| ----------------------- | ------------ | ----------- | ------------------------------------------------------------------------------ |
| `e`                     | `MouseEvent` | _parameter_ | jrvnkejrnvjern _note: `e` is used as it is common convention for mouse events_ |
| `currentAnimationFrame` | ``           | _variable_  |                                                                                |
| `rect`                  | ``           | _variable_  |                                                                                |
| `x`                     | ``           | _variable_  |                                                                                |
| `y`                     | ``           | _variable_  |                                                                                |
| `e.clientX`             | ``           | _variable_  |                                                                                |
...
| `node.y`                    | ``           | _variable_  |                                                                                |
| `radius`                    | ``           | _variable_  |                                                                                |
| `targetNode`                | ``           | _variable_  |                                                                                |
| `targetNode.id`             | ``           | _variable_  |                                                                                |
| `draggingConnection.fromId` | ``           | _variable_  |                                                                                |
| `connections`               | ``           | _variable_  |                                                                                |
