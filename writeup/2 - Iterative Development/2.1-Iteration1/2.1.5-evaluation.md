...
This, to me, is a minor success; certainly not all the boxes have been checked at this point, mainly due to persistent errors, some of which I haven't yet been able to debug - ***these will carry over to Iteration 2***, where I will hopefully be able to resole them. Significant progress has been made, though notably not as much as I wanted to. This suggests to me I need to put more time into Iteration 2 (*in the parts that matter, instead of focuding on minor bugs/ details*)
