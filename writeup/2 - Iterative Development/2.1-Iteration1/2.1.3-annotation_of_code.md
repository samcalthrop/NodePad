...
export const EditNodeMetaScreen = (): JSX.Element => {
  ...
  // hard-coded path to the root of this project in order to retrieve test data from the backend
  const path = './';
