...
As an additional check, I followed the debug logs to check that the data was being correctly passed at each point:
...
To test this works, set the default directory to search be the root of this project and once more loaded the app and navigated to the home screen:

#### Testing

- tree is correctly rendered with icons + children
- tree leaves can be clicked on, open, closed etc.
