...
##### Test 2: Validation/ sanitation of input
...
##### Test 1: Validation/ sanitation of input
...
##### Test 1: Tree is correctly rendered with icons + children
...
##### Test 2: Folders can be clicked on, opened, and closed
...
##### Test 3: Markdown files can be opened by clicking
...
##### Test 4: Sidebar contents are consistent
...
<div align='center'>
  <img src='./src/testSidebar4.gif' style="max-height: 600px; border-radius: 6px;"/>
</div>

##### Test 5: Filetree sits in the Sidebar without affecting other components
