...
| Description                                                                                                                                                                                           | Result         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| The central login card should stay a fixed width in the centre of the page, unless the width or height is less than the width or height of the card. In this case, the card should shrink accordingly | **Success** ✅ |
...
| Description                                                                                                                                                                                            | Result         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------- |
| The central signup card should stay a fixed width in the centre of the page, unless the width or height is less than the width or height of the card. In this case, the card should shrink accordingly | **Success** ✅ |
...
| Description                                                                                                                                                                                                            | Result                                                                                                                                                     |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The sidebar should stay a on the left side of the screen with a margin from the top, bottom, and left of the screen. If the height of the screen shrinks, it should do the same in order to maintain the margin indent | **Failure** ❌ - _the Sidebar's height is independent of the height of the screen, and shrinking just causes the content to go off the bottom of the page_ |
