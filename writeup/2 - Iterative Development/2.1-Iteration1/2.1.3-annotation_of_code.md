...
| Description                                                                                                                                                                                 | Result                                                                                                                                                       |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| The user should be able to navigate through the app exactly as [the routes are defined in Design Part 1 - User Flows](../../3%20-%20Design/3.1%20-%20Design%20Part%20I/3.1.4-user_flow.md). | **Partial Success** 🟨 - _all routes I've implemented work, however I haven't made the settings or edit modes yet, so obviously these can't be navigated to_ |
...
| Description                                                                                     | Result         |
| ----------------------------------------------------------------------------------------------- | -------------- |
| The user should be able to navigate to and from the Signup screen by means of a sign up button. | **Success** ✅ |
...
| Description                                                                                                                                       | Result         |
| ------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| The user must enter valid login data to be accepted (`email` must contain an `@` and a proceeding `.`, and password must be ≥ 8 characters long). | **Success** ✅ |
...
| Description                                                                                                                                                                                                     | Result                                                                                                                 |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| The user must enter valid signup data to be accepted as a new user (`email` must contain an `@` and a proceeding `.`, the password must be ≥ 8 characters long _and_ the two password fields must be identical) | **Failure** ❌ - _currently, entering anything into the fields, or even nothing at all results in a successful signup_ |
...
| Description                                                                                                                                                                                                                         | Result                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| The Sidebar correctly displays the contents of a given source directory, displays closed folders with a closed folder icon, displays open folders with an open folder icon, and displays markdown documents with an open book icon. | **Partial Success** 🟨 - _markdown icons are rendering correctly, but folder icons only render for folders with children_ |
...
| Description                                                                                                                                                                                     | Result         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| When leaves of the tree are clicked on: if the leaf is a folder, the leaf should be expanded and its children shown indented below it, with the closed folder icon becoming an open folder icon | **Success** ✅ |
...
| Description                                                                                                                    | Result                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| When leaves of the tree are clicked on: if the leaf is a markdown file, the user should be navigated to the text editor screen | **Success** ✅ - _the contents of the file are not displayed, though this is an issue to be addressed/ tested for when I build up the text editor_ |
...
| Description                                                                                                                                                                                                                                                       | Result                                                                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| When a markdown file is clicked on, this causes the text editor to be opened - when this happens, the Sidebar's state must remain _i.e if one or several folders is/ are open, they should stay open even when the user navigates to a different part of the app_ | **Failure** ❌ - _when the user is navigated to the text editor, the file tree is reset, even taking a second or two to re-retrieve and load its contents_ |
...
| Description                                                                             | Result                                                                                                                                                                                                                        |
| --------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| When the filetree is collapsed/ expanded, the Sidebar's size/ styling should not change | **Failure** ❌ - _the Sidebar becomes more elongated when files are expanded, even going off the page sometimes, and the original size is achieved by collapsing these folders - the Sidebar should remain a consistent size_ |
...
| Description                                                                                                 | Result         |
| ----------------------------------------------------------------------------------------------------------- | -------------- |
| Check that the file clicked on in the Sidebar has the correct contents retrieved from the user's filesystem | **Success** ✅ |
...
| Description                                                                                                              | Result                                                                                                              |
| ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| Check that the same contents retrieved from the user's filesystem are then displayed on the frontend, in the text editor | **Failure** ❌ - _the contents are failing to load, resulting in the 'Failed to retrieve contents' being displayed_ |
...
| Description                                                                                                           | Result         |
| --------------------------------------------------------------------------------------------------------------------- | -------------- |
| Test that whatever content is displayed in the text area within the text editor is rendered using markdown formatting | **Success** ✅ |
...
| Description                                                                                                                                                                                           | Result                                                                                         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| The central login card should stay a fixed width in the centre of the page, unless the width or height is less than the width or height of the card. In this case, the card should shrink accordingly | **Partial Success** 🟨 - _components are resizing well, but should have a maximum fixed width_ |
...
| Description                                                                                                                                                                                            | Result                                                                                         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------- |
| The central signup card should stay a fixed width in the centre of the page, unless the width or height is less than the width or height of the card. In this case, the card should shrink accordingly | **Partial Success** 🟨 - _components are resizing well, but should have a maximum fixed width_ |
...
| Description                                                                                                                                                                                                            | Result                                                                                                                                                                                                                                         |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| The sidebar should stay a on the left side of the screen with a margin from the top, bottom, and left of the screen. If the height of the screen shrinks, it should do the same in order to maintain the margin indent | **Partial Success** 🟨 - _the Sidebar's height is independent of the height of the screen, and shrinking just causes the content to go off the bottom of the page. However, it retains margins to the left and top, and its width stays fixed_ |
...
| Description                                                                                                                                                                                             | Result         |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| The content of the Home screen should fit within the remaining area of the screen (the area not taken up by the Sidebar), and text should remain a constant width regardless of the width of the screen | **Success** ✅ |
...
| Description                                                                                                                                           | Result         |
| ----------------------------------------------------------------------------------------------------------------------------------------------------- | -------------- |
| The content of the text editor should shrink to a minimum width, and the text should overflow off the screen if its height exceeds that of the screen | **Success** ✅ |
...
| Description                                                                                                        | Result                                                                                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Test that the colours used for each screen in the app make sense, and are consistent _i.e. 'all buttons are blue'_ | **Partial Success** 🟨 - _component colours are consistent, however there are come colours that don't fit the scheme, for example the folder icons are orange, and no other part of the app is in any way similar_ |
