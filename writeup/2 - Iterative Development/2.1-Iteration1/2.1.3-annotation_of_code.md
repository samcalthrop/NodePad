...
### Testing
1. The app opens to a blank screen with just this code:

2. The defined routes all work as they should - this includes the app opening to the login page by default, **once the screens have all been made**. This means I can only test this after the other screens have been made and tested:
