...
As a result, I can use these to style each part of the app, and any changes I make to this file will be seen app-wide without the need for individual modification.
