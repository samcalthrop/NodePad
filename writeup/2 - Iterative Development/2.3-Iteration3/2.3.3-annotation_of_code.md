...
The functionality behind the new file button is relatively simple, reusing the `window.ipcAPI.saveFile()` method created [when implementing saving](#adding-saving):
